...
namespace Tp_2.WSMeteo {
    ...
    public interface meteo3ilSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Tp_2.WSMeteo.Get_ValueResponse Get_Value(Tp_2.WSMeteo.Get_ValueRequest request);
        
        // CODEGEN : Génération du contrat de message dans la mesure où l'opération compte plusieurs valeurs de retour.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Get_Value", ReplyAction="*")]
        System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueResponse> Get_ValueAsync(Tp_2.WSMeteo.Get_ValueRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Get_ValueByDate", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Tp_2.WSMeteo.Get_ValueByDateResponse Get_ValueByDate(Tp_2.WSMeteo.Get_ValueByDateRequest request);
        
        // CODEGEN : Génération du contrat de message dans la mesure où l'opération compte plusieurs valeurs de retour.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Get_ValueByDate", ReplyAction="*")]
        System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueByDateResponse> Get_ValueByDateAsync(Tp_2.WSMeteo.Get_ValueByDateRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Get_ValueByPeriod", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        Tp_2.WSMeteo.Get_ValueByPeriodResponse Get_ValueByPeriod(Tp_2.WSMeteo.Get_ValueByPeriodRequest request);
        
        // CODEGEN : Génération du contrat de message dans la mesure où l'opération compte plusieurs valeurs de retour.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/Get_ValueByPeriod", ReplyAction="*")]
        System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueByPeriodResponse> Get_ValueByPeriodAsync(Tp_2.WSMeteo.Get_ValueByPeriodRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface meteo3ilSoapChannel : Tp_2.WSMeteo.meteo3ilSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class meteo3ilSoapClient : System.ServiceModel.ClientBase<Tp_2.WSMeteo.meteo3ilSoap>, Tp_2.WSMeteo.meteo3ilSoap {
        ...
        Tp_2.WSMeteo.Get_ValueResponse Tp_2.WSMeteo.meteo3ilSoap.Get_Value(Tp_2.WSMeteo.Get_ValueRequest request) {
        ...
        public string Get_Value(int i_NumValue, out string s_DateValue, out string s_DescValue) {
            Tp_2.WSMeteo.Get_ValueRequest inValue = new Tp_2.WSMeteo.Get_ValueRequest();
            inValue.i_NumValue = i_NumValue;
            Tp_2.WSMeteo.Get_ValueResponse retVal = ((Tp_2.WSMeteo.meteo3ilSoap)(this)).Get_Value(inValue);
            s_DateValue = retVal.s_DateValue;
            s_DescValue = retVal.s_DescValue;
            return retVal.Get_ValueResult;
        }
        
        public System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueResponse> Get_ValueAsync(Tp_2.WSMeteo.Get_ValueRequest request) {
            return base.Channel.Get_ValueAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Tp_2.WSMeteo.Get_ValueByDateResponse Tp_2.WSMeteo.meteo3ilSoap.Get_ValueByDate(Tp_2.WSMeteo.Get_ValueByDateRequest request) {
        ...
        public string Get_ValueByDate(int i_NumValue, string s_DateValueIn, out string s_DateValueOut, out string s_DescValue) {
            Tp_2.WSMeteo.Get_ValueByDateRequest inValue = new Tp_2.WSMeteo.Get_ValueByDateRequest();
            inValue.i_NumValue = i_NumValue;
            inValue.s_DateValueIn = s_DateValueIn;
            Tp_2.WSMeteo.Get_ValueByDateResponse retVal = ((Tp_2.WSMeteo.meteo3ilSoap)(this)).Get_ValueByDate(inValue);
            s_DateValueOut = retVal.s_DateValueOut;
            s_DescValue = retVal.s_DescValue;
            return retVal.Get_ValueByDateResult;
        }
        
        public System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueByDateResponse> Get_ValueByDateAsync(Tp_2.WSMeteo.Get_ValueByDateRequest request) {
            return base.Channel.Get_ValueByDateAsync(request);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Tp_2.WSMeteo.Get_ValueByPeriodResponse Tp_2.WSMeteo.meteo3ilSoap.Get_ValueByPeriod(Tp_2.WSMeteo.Get_ValueByPeriodRequest request) {
        ...
        public System.Data.DataSet Get_ValueByPeriod(int i_NumValue, string s_DateValue1, string s_DateValue2, out int i_Count, out string s_DescValue) {
            Tp_2.WSMeteo.Get_ValueByPeriodRequest inValue = new Tp_2.WSMeteo.Get_ValueByPeriodRequest();
            inValue.i_NumValue = i_NumValue;
            inValue.s_DateValue1 = s_DateValue1;
            inValue.s_DateValue2 = s_DateValue2;
            Tp_2.WSMeteo.Get_ValueByPeriodResponse retVal = ((Tp_2.WSMeteo.meteo3ilSoap)(this)).Get_ValueByPeriod(inValue);
            i_Count = retVal.i_Count;
            s_DescValue = retVal.s_DescValue;
            return retVal.Get_ValueByPeriodResult;
        }
        
        public System.Threading.Tasks.Task<Tp_2.WSMeteo.Get_ValueByPeriodResponse> Get_ValueByPeriodAsync(Tp_2.WSMeteo.Get_ValueByPeriodRequest request) {
